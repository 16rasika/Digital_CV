...
st.markdown("<h2 style='text-align: center; color: black;'>Thank you for taking time to visit my Profile!👋 Welcome</h2>", unsafe_allow_html=True)
...
('Data Visualization', '`Seaborn`, `Tableu`,`Matplotlib`,`plotly`')
